...
# Actually it is easier to just replace the whole QHBoxLayout horzLayoutVshMain again with updated content
...
print("mainwindow.ui successfully updated with simplified VSH tab layout!")
