...
# Remove all existing standard layouts inside tabShaleVolume
for layout in list(tab_vsh):
    if layout.tag in ["layout"]:
        tab_vsh.remove(layout)

# We will supply the new layout as string and inject it
new_layout_xml = """
      ...
      <item>
       <widget class="QGroupBox" name="groupVshInputParameters">
        ...
        <layout class="QFormLayout" name="formVshInput">
         ...
         <item row="3" column="1"><widget class="QComboBox" name="comboVclMethod" /></item>

         <item row="4" column="0"><widget class="QLabel" name="lblVshAge"><property name="text"><string>Formation Age</string></property></widget></item>
         <item row="4" column="1"><widget class="QComboBox" name="comboVshAge">
          <item><property name="text"><string>Tertiary</string></property></item>
          <item><property name="text"><string>Older</string></property></item>
         </widget></item>
        </layout>
       </widget>
      </item>
...
print("mainwindow.ui successfully updated with new VSH tab layout!")
